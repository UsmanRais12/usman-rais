          ...
          <div key={index} className='mb-8 flex flex-wrap lg:justify-center'> 
            ...
            <motion.div
             ...
             className='w-full max-w-xl lg:w-3/4'>
              <h6 className='mb-2 font-semibold'><a href={experience.link} target='_blank'>{experience.role} - <span className='text-sm text-purple-100'>{experience.company}</span></a></h6>
